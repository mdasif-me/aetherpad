    ...
    <div className='flex items-center gap-x-0.5'>
      ...
      {isEditing ? (
        <input
          ...
          className='h-7 w-7 shrink-0 border border-neutral-400 text-center rounded-sm bg-transparent focus:outline-none focus:ring-0 focus:ring-offset-0'
        />
      ) : (
        <button
          className='h-7 w-7 shrink-0 border border-neutral-400 text-center rounded-sm hover:bg-neutral-200/80'
          onClick={() => {
            setIsEditing(true);
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className='h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm'>
          <ListIcon className='size-4 mb-0.5' />
        </button>
      </DropdownMenuTrigger>
